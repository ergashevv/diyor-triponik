...
export default defineEventHandler(async (event) => {
    ...
    try {
        const localesDir = path.resolve('locales/akbarjon'); // Asosiy ish papkasi
        ...
        // `locales/akbarjon` papkasini tekshirish
        ...
        // JSON fayllarni o'qish (locales/akbarjon dan)
        ...
        // `locales/akbarjon` da fayllarni yangilash
