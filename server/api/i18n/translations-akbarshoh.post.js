...
export default defineEventHandler(async (event) => {
    ...
    try {
        const localesDir = path.resolve('locales/akbarshoh'); // Asosiy ish papkasi
        const checkDir = path.resolve('locales/anvarjon'); // Tekshirish uchun papka
        ...
        // `locales/anvarjon` da JSON fayllarni o'qish va kalitni tekshirish
        ...
        // `locales/anvarjon` da kalit mavjudligini tekshirish
        ...
        // JSON fayllarni o'qish (locales/akbarshoh dan)
        ...
        // `locales/akbarshoh` da fayllarni yangilash
