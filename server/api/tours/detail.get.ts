...
export default defineEventHandler(async (event) => {
  ...
  return {
    ...
    score: baseTour.score || 9.2,
    stars: baseTour.stars || 4,
    dateLabel: 'Yaqin orada jo\'nash',
    images: [
      baseTour.image,
    ...
    variants: [
      { roomName: "Standart xona", meal: 'AI - Barchasi kiritilgan', departure: '19 iyul', returnDate: '26 iyul', nights: 7, hotelNights: 6, price: baseTour.price },
      { roomName: "Deluxe xona", meal: 'BB - Nonushta', departure: '19 iyul', returnDate: '26 iyul', nights: 7, hotelNights: 6, price: baseTour.price + 50 },
      { roomName: "Family Suite", meal: 'FB - To\'liq pansion', departure: '19 iyul', returnDate: '26 iyul', nights: 7, hotelNights: 6, price: baseTour.price + 150 }
    ],
    tourDates: [
      ...
      { label: '19 iyul, shan', price: baseTour.price,  rubPrice: null,      bestPrice: true,  active: true  },
